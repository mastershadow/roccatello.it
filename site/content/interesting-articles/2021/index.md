+++
title = "2021's interesting articles archive"
summary = "This page contains all the article worth reading, I collected in 2021"
...
{{< small >}}2021-12-16{{< /small >}}<br>
[GitHub - spencertipping/jit-tutorial: How to write a very simple JIT compiler](https://github.com/spencertipping/jit-tutorial#?)
...
{{< small >}}2021-12-12{{< /small >}}<br>
[GitHub - tsherif/space-shooter.c: A cross-platform, top-down 2D space shooter written in C using only platform libraries.](https://github.com/tsherif/space-shooter.c#?)

{{< small >}}2021-12-10{{< /small >}}<br>
[Defensive CSS](https://ishadeed.com/article/defensive-css/#?)

{{< small >}}2021-12-09{{< /small >}}<br>
...
{{< small >}}2021-12-09{{< /small >}}<br>
[GitHub - jam-systems/jam: 🍓 Jam is your own open source Clubhouse for mini conferences, friends, communities](https://github.com/jam-systems/jam#?)
...
{{< small >}}2021-12-08{{< /small >}}<br>
[Sol Kennedy | TidyCal](https://tidycal.com/sol#?)

{{< small >}}2021-12-07{{< /small >}}<br>
...
{{< small >}}2021-12-07{{< /small >}}<br>
[Scrumfall: Why Agile Teams Revert to Waterfall](https://www.amazingcto.com/why-we-always-endup-with-waterfall-even-scrum/#?)

{{< small >}}2021-12-05{{< /small >}}<br>
...
{{< small >}}2021-11-21{{< /small >}}<br>
[Pablo](https://pablojs.com/#?)

{{< small >}}2021-11-21{{< /small >}}<br>
[1-Line Layouts](https://1linelayouts.com/#?)

{{< small >}}2021-11-18{{< /small >}}<br>
[tldraw](https://www.tldraw.com/#?)

{{< small >}}2021-11-13{{< /small >}}<br>
[Beware of fast-math](https://simonbyrne.github.io/notes/fastmath/#?)

{{< small >}}2021-11-13{{< /small >}}<br>
[About - Project Euler](https://projecteuler.net/#?)

{{< small >}}2021-11-09{{< /small >}}<br>
[Lesser Known PostgreSQL Features](https://hakibenita.com/postgresql-unknown-features#?)

{{< small >}}2021-11-09{{< /small >}}<br>
[The Ancient Secrets of Computer Vision](https://pjreddie.com/courses/computer-vision/#?)

{{< small >}}2021-11-03{{< /small >}}<br>
[GitHub - Shopify/toxiproxy: :alarm_clock: A TCP proxy to simulate network and system conditions for chaos and resiliency testing](https://github.com/Shopify/toxiproxy#?)
...
{{< small >}}2021-10-27{{< /small >}}<br>
[pacha.dev/blog - Comparing SQLite, DuckDB and Arrow with UN Trade Data](https://pacha.dev/blog/2021/08/27/comparing-sqlite-duckdb-and-arrow-with-un-trade-data/#?)
...
{{< small >}}2021-10-25{{< /small >}}<br>
[How We Built a Truly Smart Office System Based on Raspberry Pi | Monterail blog | Monterail](https://www.monterail.com/blog/2016/smart-office-raspberry-pi#?)
...
[Algorithm Grading Rubric](https://docs.google.com/spreadsheets/d/1gy9cmPwNhZvola7kqnfY3DElk7PYrz2ARpaCODTp8Go/edit#?)

{{< small >}}2021-10-20{{< /small >}}<br>
[Web Browser Engineering](https://browser.engineering/#?)

{{< small >}}2021-10-20{{< /small >}}<br>
[Function Pipelines: Building Functional Programming Into PostgreSQL](https://www.tigerdata.com/blog/function-pipelines-building-functional-programming-into-postgresql-using-custom-operators#?)
...
{{< small >}}2021-10-20{{< /small >}}<br>
[Five Things We Still Don’t Know About Water](https://nautil.us/five-things-we-still-dont-know-about-water-235479/#?)

{{< small >}}2021-10-20{{< /small >}}<br>
[Try The Mathematical Tripos](https://learnaifromscratch.github.io/math.html#?)
...
[CadHub](https://cadhub.xyz/u/caterpillar/moving_fish/ide#?)

{{< small >}}2021-10-19{{< /small >}}<br>
[Was Google Earth Stolen? (no)](https://avibarzeev.medium.com/was-google-earth-stolen-7d1b821e589b#?)
...
{{< small >}}2021-10-16{{< /small >}}<br>
[What is Nomad? | Nomad | HashiCorp Developer](https://developer.hashicorp.com/nomad/docs/what-is-nomad#?)
...
{{< small >}}2021-10-08{{< /small >}}<br>
[Deep Learning Paper Recap - Language Models](https://www.assemblyai.com/blog/deep-learning-paper-recap-language-models#?)

{{< small >}}2021-10-06{{< /small >}}<br>
...
{{< small >}}2021-10-05{{< /small >}}<br>
[GitHub - joewdavies/geoblender: Tutorials for making 3D-looking maps with Blender and QGIS](https://github.com/JoeWDavies/geoblender#?)

{{< small >}}2021-10-05{{< /small >}}<br>
[My Logging Best Practices](https://tuhrig.de/my-logging-best-practices/#?)

{{< small >}}2021-09-16{{< /small >}}<br>
[Why Authorization is Hard](https://www.osohq.com/post/why-authorization-is-hard#?)

{{< small >}}2021-09-04{{< /small >}}<br>
[A Gentle Introduction to Graph Neural Networks](https://distill.pub/2021/gnn-intro/#?)

{{< small >}}2021-09-04{{< /small >}}<br>
[An optimal algorithm for bounded random integers by stephentyrone · Pull Request #39143 · swiftlang/swift](https://github.com/swiftlang/swift/pull/39143#?)

{{< small >}}2021-09-01{{< /small >}}<br>
[Glean | Glean](https://glean.software/?open#?)

{{< small >}}2021-09-01{{< /small >}}<br>
[Gaussian Belief Propagation](https://gaussianbp.github.io/#?)

{{< small >}}2021-09-01{{< /small >}}<br>
[The Art of Not Taking Things Personally](https://medium.dave-bailey.com/the-art-of-not-taking-things-personally-b7a8395ce172?gi=32017d73a8c3#?)

{{< small >}}2021-09-01{{< /small >}}<br>
[Multiplying Matrices Without Multiplying](https://arxiv.org/abs/2106.10860#?)

{{< small >}}2021-09-01{{< /small >}}<br>
[First Public Working Draft: CSS Nesting Module](https://www.w3.org/news/2021/first-public-working-draft-css-nesting-module/#?)

{{< small >}}2021-08-30{{< /small >}}<br>
[Software Development Waste · It Will Never Work in Theory](https://neverworkintheory.org/2021/08/29/software-development-waste.html#?)

{{< small >}}2021-08-30{{< /small >}}<br>
[RBAC like it was meant to be](https://tailscale.com/blog/rbac-like-it-was-meant-to-be#?)

{{< small >}}2021-08-30{{< /small >}}<br>
[“If software engineering is in demand, why is it so hard to get a software engineering job?”](https://medium.com/better-programming/if-software-engineering-is-in-demand-why-is-it-so-hard-to-get-a-software-engineering-job-c043a964e463#?)

{{< small >}}2021-08-29{{< /small >}}<br>
...
{{< small >}}2021-08-28{{< /small >}}<br>
[GitHub - marceloprates/prettymaps: Draw pretty maps from OpenStreetMap data! Built with osmnx +matplotlib + shapely](https://github.com/marceloprates/prettymaps#?)

{{< small >}}2021-08-27{{< /small >}}<br>
...
{{< small >}}2021-08-07{{< /small >}}<br>
[What Are Convolutional Neural Networks?](https://serokell.io/blog/introduction-to-convolutional-neural-networks#?)

{{< small >}}2021-08-06{{< /small >}}<br>
[SAML is insecure by design](https://joonas.fi/2021/08/saml-is-insecure-by-design/#?)

{{< small >}}2021-08-03{{< /small >}}<br>
...
{{< small >}}2021-07-21{{< /small >}}<br>
[I ****ing hate Science](https://buttondown.com/hillelwayne/archive/i-ing-hate-science/#?)
...
{{< small >}}2021-07-19{{< /small >}}<br>
[The Blurred Lines of Parasocial Relationships](https://every.to/cybernaut/the-blurred-lines-of-parasocial-relationships#?)

{{< small >}}2021-07-18{{< /small >}}<br>
[Towards Inserting One Billion Rows in SQLite Under A Minute - blag](https://avi.im/blag/2021/fast-sqlite-inserts/#?)

{{< small >}}2021-07-16{{< /small >}}<br>
[My Take on The Study From MIT That Predicts “Societal Collapse”](https://blog.startupstash.com/my-take-on-the-study-from-mit-that-predicts-societal-collapse-b351d8fbd4c2?gi=5c1054e124c9#?)

{{< small >}}2021-07-16{{< /small >}}<br>
[Predictably Productive - Overcome procrastination with 10 min a day](https://www.deprocrastination.co/course#?)

{{< small >}}2021-07-15{{< /small >}}<br>
[The Blender Studio Pipeline - Blender Studio](https://studio.blender.org/blog/the-blender-studio-pipeline/#?)

{{< small >}}2021-07-15{{< /small >}}<br>
[Assertiveness is a virtue that anyone can develop with practice | Psyche Ideas](https://psyche.co/ideas/assertiveness-is-a-virtue-that-anyone-can-develop-with-practice#?)

{{< small >}}2021-07-13{{< /small >}}<br>
...
{{< small >}}2021-07-10{{< /small >}}<br>
[GitHub - romeovs/creep: a pretty sweet 4px wide pixel font.](https://github.com/romeovs/creep#?)
...
{{< small >}}2021-07-09{{< /small >}}<br>
[GitHub - robhagemans/hoard-of-bitfonts: turns out I like bitmap fonts](https://github.com/robhagemans/hoard-of-bitfonts#?)

{{< small >}}2021-07-09{{< /small >}}<br>
[SpriteStack.io](https://spritestack.io/#?)

{{< small >}}2021-07-08{{< /small >}}<br>
...
{{< small >}}2021-07-03{{< /small >}}<br>
[The Untold Story of SQLite - CoRecursive Podcast](https://corecursive.com/066-sqlite-with-richard-hipp/#?)

{{< small >}}2021-07-03{{< /small >}}<br>
[How to Be a Genius](https://forge.medium.com/how-to-be-a-genius-6d8b3709edca#?)

{{< small >}}2021-07-03{{< /small >}}<br>
[bibliothecula - tagged document storage](https://epilys.github.io/bibliothecula/notekeeping.html#?)

{{< small >}}2021-07-03{{< /small >}}<br>
[Release darktable 3.6.0 released · darktable-org/darktable](https://github.com/darktable-org/darktable/releases/tag/release-3.6.0#?)

{{< small >}}2021-06-27{{< /small >}}<br>
...
{{< small >}}2021-06-21{{< /small >}}<br>
[CatMeows: A Publicly-Available Dataset of Cat Vocalizations](https://zenodo.org/records/4008297#?)
...
{{< small >}}2021-06-13{{< /small >}}<br>
[Why Can’t I Sleep?](https://magazine.ucsf.edu/why-cant-i-sleep#?)

{{< small >}}2021-06-13{{< /small >}}<br>
[Plan2Scene](https://3dlg-hcvc.github.io/plan2scene/#?)

{{< small >}}2021-06-13{{< /small >}}<br>
[Containers are tents – Increment: Containers](https://increment.com/containers/containers-vs-vms/#?)

{{< small >}}2021-06-13{{< /small >}}<br>
[GitHub - MayaPosch/NymphCast: Audio and video casting system with support for custom applications.](https://github.com/MayaPosch/NymphCast/#?)

{{< small >}}2021-06-13{{< /small >}}<br>
[Release v7.0.0 · d3/d3](https://github.com/d3/d3/releases/tag/v7.0.0#?)

{{< small >}}2021-06-13{{< /small >}}<br>
[The Modern Mathematics of Deep Learning](https://arxiv.org/abs/2105.04026#?)

{{< small >}}2021-06-13{{< /small >}}<br>
[Burnout From an Organizational Perspective (SSIR)](https://ssir.org/articles/entry/burnout_from_an_organizational_perspective#?)

{{< small >}}2021-06-13{{< /small >}}<br>
[Doing Something is Better Than Doing Nothing for Most People, Study Shows](https://news.virginia.edu/content/doing-something-better-doing-nothing-most-people-study-shows#?)

{{< small >}}2021-06-11{{< /small >}}<br>
[DO NOT SUBSCRIBE HERE subscribe at wheresyoured.at | Ed Zitron | Substack](https://ez.substack.com/welcome#?)

{{< small >}}2021-06-11{{< /small >}}<br>
[Moving my home media library from iTunes to Jellyfin and Infuse | Jeff Geerling](https://www.jeffgeerling.com/blog/2021/moving-my-home-media-library-itunes-jellyfin-and-infuse#?)

{{< small >}}2021-06-11{{< /small >}}<br>
[Raspberry Pi WiFi Ethernet Bridge - Will Haley](https://www.willhaley.com/blog/raspberry-pi-wifi-ethernet-bridge/#?)
...
{{< small >}}2021-06-07{{< /small >}}<br>
[Building a new vector based storage model | QuestDB](https://questdb.com/blog/building-a-new-vector-based-storage-model/#?)
...
{{< small >}}2021-05-30{{< /small >}}<br>
[SQLite Data Starter Packs | Public Affairs Data Journalism at Stanford | Fall 2016](http://2016.padjo.org/tutorials/sqlite-data-starterpacks/#?)
...
{{< small >}}2021-05-21{{< /small >}}<br>
[Extreme HTTP Performance Tuning: 1.2M API req/s on a 4 vCPU Instance](https://talawah.io/blog/extreme-http-performance-tuning-one-point-two-million/#?)

{{< small >}}2021-05-21{{< /small >}}<br>
[Text Editing Hates You Too – Lord.io](https://lord.io/text-editing-hates-you-too/#?)

{{< small >}}2021-05-20{{< /small >}}<br>
...
{{< small >}}2021-05-16{{< /small >}}<br>
[Why introverts make great leaders](https://thehustle.co/why-introverts-make-great-leaders#?)
...
{{< small >}}2021-05-12{{< /small >}}<br>
[Good Data Scientist, Bad Data Scientist](https://ianwhitestone.work/good-ds-bad-ds/#?)

{{< small >}}2021-05-12{{< /small >}}<br>
[Just Use Email](https://justuseemail.com/#?)

{{< small >}}2021-05-12{{< /small >}}<br>
[The AirGradient DIY Air Quality Sensor (Basic Version PCB Version 4.0+)](https://www.airgradient.com/documentation/diy-v4/#?)
...
{{< small >}}2021-05-11{{< /small >}}<br>
[Site unavailable](https://www.narratordata.com/blog/using-postgresql-as-a-data-warehouse/#?)

{{< small >}}2021-05-11{{< /small >}}<br>
[Can I email…](https://www.caniemail.com/#?)

{{< small >}}2021-05-10{{< /small >}}<br>
[Improving DISTINCT Query Performance Up to 8,000x on PostgreSQL](https://www.tigerdata.com/blog/how-we-made-distinct-queries-up-to-8000x-faster-on-postgresql#?)

{{< small >}}2021-05-09{{< /small >}}<br>
...
{{< small >}}2021-05-06{{< /small >}}<br>
[Introducing the Anim State Graph | PlayCanvas Blog](https://blog.playcanvas.com/introducing-the-anim-state-graph/#?)
...
{{< small >}}2021-05-04{{< /small >}}<br>
[The art of solving problems with Monte Carlo simulations | Gabriel Carvalho](https://ggcarvalho.dev/posts/montecarlo/#?)

{{< small >}}2021-05-03{{< /small >}}<br>
[Principal Component Analysis explained visually](https://setosa.io/ev/principal-component-analysis/#?)

{{< small >}}2021-05-02{{< /small >}}<br>
[Query Engines: Push vs. Pull](https://justinjaffray.com/query-engines-push-vs.-pull/#?)

{{< small >}}2021-05-01{{< /small >}}<br>
...
{{< small >}}2021-04-29{{< /small >}}<br>
[How to write cold emails to investors – lessons from 30 VCs](https://www.maestrolabs.com/how-to/cold-email-to-investors#?)

{{< small >}}2021-04-28{{< /small >}}<br>
[Replit — Why We Switched From Webpack To Vite](https://blog.replit.com/vite#?)

{{< small >}}2021-04-27{{< /small >}}<br>
[pg_tmp(1)](http://eradman.com/ephemeralpg/#?)
...
{{< small >}}2021-04-26{{< /small >}}<br>
[Open source geocoder and addresses database / POIs database in CSV](https://www.gisgraphy.com/index.php#?)

{{< small >}}2021-04-26{{< /small >}}<br>
[Causal: The finance platform for startups](https://www.causal.app/#?)
...
{{< small >}}2021-04-25{{< /small >}}<br>
[Exclusive Photos Inside the Chernobyl Nuclear Power Plant](https://petapixel.com/2021/04/24/exclusive-photos-inside-the-chernobyl-nuclear-power-plant/#?)

{{< small >}}2021-04-25{{< /small >}}<br>
[Dynamic Programming vs Divide-and-Conquer | Trekhleb](https://trekhleb.dev/blog/2018/dynamic-programming-vs-divide-and-conquer/#?)
...
{{< small >}}2021-04-21{{< /small >}}<br>
[The AI workspace that works for you. | Notion](https://www.notion.so/Paper-Notes-by-Vitaly-Kurin-97827e14e5cd4183815cfe3a5ecf2f4c#?)

{{< small >}}2021-04-21{{< /small >}}<br>
[Starting a TypeScript Project in 2021](https://www.metachris.com/2021/04/starting-a-typescript-project-in-2021/#?)

{{< small >}}2021-04-19{{< /small >}}<br>
[Foundations of complexity economics - Nature Reviews Physics](https://www.nature.com/articles/s42254-020-00273-3#?)

{{< small >}}2021-04-18{{< /small >}}<br>
[Tech-Centric is Just as Bad as Sales-Driven - Itamar Gilad](https://itamargilad.com/product-led/#?)

{{< small >}}2021-04-17{{< /small >}}<br>
...
{{< small >}}2021-04-17{{< /small >}}<br>
[WebGL Fingerprinting](https://jonatron.github.io/webgl-fingerprinting/#?)

{{< small >}}2021-04-16{{< /small >}}<br>
...
{{< small >}}2021-04-15{{< /small >}}<br>
[Cal.com | Open Scheduling Infrastructure](https://cal.com/#?)

{{< small >}}2021-04-15{{< /small >}}<br>
[GitHub - jberg/butterchurn: Butterchurn is a WebGL implementation of the Milkdrop Visualizer](https://github.com/jberg/butterchurn#?)

{{< small >}}2021-04-13{{< /small >}}<br>
[The True Meaning of Technical Debt 💸](https://refactoring.fm/p/the-true-meaning-of-technical-debt#?)

{{< small >}}2021-04-13{{< /small >}}<br>
[natto.dev - write JavaScript on a 2D canvas](https://natto.dev/#?)

{{< small >}}2021-04-12{{< /small >}}<br>
...
{{< small >}}2021-04-09{{< /small >}}<br>
[UX Tools – Challenges](https://www.uxtools.co/challenges#?)

{{< small >}}2021-04-09{{< /small >}}<br>
[Bikmo - Theft Map](https://bike-theft-map.bikmo.com/#?)
...
{{< small >}}2021-04-05{{< /small >}}<br>
[Prescriptive software is better than descriptive software | Kilian Valkhof](https://kilianvalkhof.com/2021/web/prescriptive-software-is-better-than-descriptive-software/#?)

{{< small >}}2021-04-04{{< /small >}}<br>
[GitHub - maplibre/maplibre-gl-js: MapLibre GL JS - Interactive vector tile maps in the browser](https://github.com/maplibre/maplibre-gl-js#?)

{{< small >}}2021-04-04{{< /small >}}<br>
[Game Engine: How I Implemented Skeletal Animation](https://vlad.website/game-engine-skeletal-animation/#?)
...
{{< small >}}2021-04-03{{< /small >}}<br>
[GitHub - climech/grit: Multitree-based personal task manager](https://github.com/climech/grit#?)

{{< small >}}2021-04-02{{< /small >}}<br>
...
{{< small >}}2021-04-01{{< /small >}}<br>
[Speech to birdsong conversion](https://www.windytan.com/2021/03/speech-to-birdsong-conversion.html#?)

{{< small >}}2021-04-01{{< /small >}}<br>
[The Deck We Used to Raise Our Seed with Accel in 13 Days | Airbyte](https://airbyte.com/blog/the-deck-we-used-to-raise-our-seed-with-accel-in-13-days#?)

{{< small >}}2021-04-01{{< /small >}}<br>
[GitHub - wezterm/wezterm: A GPU-accelerated cross-platform terminal emulator and multiplexer written by @wez and implemented in Rust](https://github.com/wezterm/wezterm#?)
...
{{< small >}}2021-03-28{{< /small >}}<br>
[Piano Practice Software Progress · Jacques Mattheij](https://jacquesmattheij.com/piano-practice-software-progress/#?)

{{< small >}}2021-03-27{{< /small >}}<br>
[PlenOctrees for Real-time Rendering of Neural Radiance Fields](https://alexyu.net/plenoctrees/#?)

{{< small >}}2021-03-26{{< /small >}}<br>
...
{{< small >}}2021-03-18{{< /small >}}<br>
[Which color scale to use when visualizing data | Datawrapper Blog](https://www.datawrapper.de/blog/which-color-scale-to-use-in-data-vis#?)
...
[Why in the World Would You Own Bonds When…](https://www.bridgewater.com/research-and-insights/why-in-the-world-would-you-own-bonds-when#?)
...
{{< small >}}2021-03-16{{< /small >}}<br>
[Improving large monorepo performance on GitHub](https://github.blog/developer-skills/github/improving-large-monorepo-performance-on-github/#?)

{{< small >}}2021-03-16{{< /small >}}<br>
[How I make graphics for retro systems and retro-styled games](https://nicole.express/2021/how-i-handle-graphics.html#?)

{{< small >}}2021-03-13{{< /small >}}<br>
...
{{< small >}}2021-03-12{{< /small >}}<br>
[Pipe | Embedded Financial Solutions](https://pipe.com/#?)
...
{{< small >}}2021-03-12{{< /small >}}<br>
[Cronitor](https://cronitor.io/real-user-monitoring?ref=panelbear#?)
...
{{< small >}}2021-03-07{{< /small >}}<br>
[Cleaning Up Your Postgres Database | Crunchy Data Blog](https://www.crunchydata.com/blog/cleaning-up-your-postgres-database#?)
...
{{< small >}}2021-02-26{{< /small >}}<br>
[A minimal email client – Manu](https://manuelmoreale.com/thoughts/emails#?)

{{< small >}}2021-02-25{{< /small >}}<br>
...
{{< small >}}2021-02-13{{< /small >}}<br>
[How Covid brought the future back - Works in Progress Magazine](https://worksinprogress.co/issue/how-covid-brought-the-future-back/#?)

{{< small >}}2021-02-12{{< /small >}}<br>
[Why I Built Litestream - Litestream](https://litestream.io/blog/why-i-built-litestream/#?)

{{< small >}}2021-02-10{{< /small >}}<br>
...
{{< small >}}2021-01-30{{< /small >}}<br>
[Creating my awesome Windows 10 dev setup](https://www.chimerical.ca/posts/creating-my-awesome-windows-10-dev-setup#?)

{{< small >}}2021-01-28{{< /small >}}<br>
[Redirecting to https://research.nvidia.com/labs/toronto-ai/nglod/](https://nv-tlabs.github.io/nglod/#?)

{{< small >}}2021-01-22{{< /small >}}<br>
...
{{< small >}}2021-01-11{{< /small >}}<br>
[Simple Anomaly Detection Using Plain SQL](https://hakibenita.com/sql-anomaly-detection#?)

{{< small >}}2021-01-10{{< /small >}}<br>
[GitHub - leereilly/games: Archived — A list of games, add-ons, maps, etc. hosted on GitHub. Any genre. Any platform. Any engine.](https://github.com/leereilly/games#?)

{{< small >}}2021-01-09{{< /small >}}<br>
...
{{< small >}}2021-01-05{{< /small >}}<br>
[Ditherpunk — The article I wish I had about monochrome image dithering — surma.dev](https://surma.dev/things/ditherpunk/#?)

{{< small >}}2021-01-03{{< /small >}}<br>
[The Mobile Map App Part I: The Void](https://worldbuilder.substack.com/p/the-mobile-map-app-part-i-the-void#?)
